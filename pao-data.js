...
const PAO_DATA = {
    ...
    rawData: [
        ...
        { code: '08', person: 'Cháu Châu', action: 'Tắm ', object: 'Con Heo' },
        ...
        { code: '50', person: 'Snoop Dog', action: 'Hút', object: 'Sữa Chua' },
        ...
        { code: '54', person: 'ca sĩ Siu black', action: 'Ngửi', object: 'Sầu Riêng' },
        { code: '55', person: 'chị Sợi', action: 'Gọt vỏ', object: 'Su Su' },
        { code: '56', person: 'Pak Hang SEO', action: 'Lướt sóng', object: 'Sóng Biển' },
        { code: '57', person: 'em Sỏi địa chính', action: 'Sạc', object: 'Sạc Pin' },
        ...
        { code: '64', person: 'Big Daddy', action: 'Úp rổ', object: 'Bóng Rổ' },
        { code: '65', person: 'Xuân Bắc', action: 'Bắt mạch', object: 'Bác Sĩ' },
        { code: '66', person: 'Vợ Bình', action: 'Bơm phồng', object: 'Bóng Bay' },
        { code: '67', person: 'Bill Gate', action: 'Gõ 10 ngón', object: 'Bàn Phím' },
        ...
        { code: '71', person: 'Cô Phán thảo', action: 'Hóa trang thành', object: 'Phù Thủy' },
    ...
    // Special codes
    specialCodes: [
        { code: 'JC', person: 'Bác sĩ Gấm', action: 'Cắm điện', object: 'Giắc Cắm' },
