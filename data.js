...
const imageFiles = [
    ...
    { num: '05', name: 'The Rock', file: '05 - Cá Sấu.jpg' },
    { num: '5', name: 'Đông Tà Hoàng Dược Sư', file: 's-5-thoi-sao-hoang-duoc-su.jpg' },
...
const paoDataOriginal = {
    ...
    '05': { person: 'The Rock', action: 'Vật Ngã', object: 'Cá Sấu', story: 'The Rock khỏe như lực sĩ lao vào Vật Ngã ngửa bụng một con Cá Sấu khổng lồ.' },
    '5': { person: 'Đông Tà Hoàng Dược Sư', action: 'Thổi sáo', object: 'Sáo trúc', story: 'Hoàng Dược Sư oai phong cầm tiêu lên Thổi sáo tiêu âm điều khiển mọi thứ.' },
