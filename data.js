...
const paoData = {
    ...
    '04': { person: 'Cháu Chi', action: 'Thôi Miên', object: 'Con Rắn', story: 'Cháu Chi thổi sáo nghệ thuật để Thôi Miên một Con Rắn hổ mang chúa đang múa.' },
    ...
    '06': { person: 'em Cúc', action: 'Đập', object: 'Cái Búa', story: 'Em Cúc giận dữ Đập mạnh cái Cái Búa xuống bàn' },
    ...
    '16': { person: 'anh Tuấn The Zei', action: 'Đeo', object: 'Túi Balo', story: 'Anh Tuấn The Zei đang loay hoay Đeo ngược cái Túi Balo to tướng trước ngực.' },
    ...
    '20': { person: 'Con Ngọc', action: 'Hứng từng giọt', object: 'Nước Cất', story: 'Con Ngọc kiên nhẫn cầm cốc pha lê Hứng từng giọt tinh khiết của Nước Cất.' },
    ...
    '26': { person: 'chị Nga đồng tu', action: 'Dâng', object: 'Nhẫn Bạc', story: 'Chị Nga đồng tu trân trọng quỳ xuống dùng hai tay Dâng lên một chiếc Nhẫn Bạc sáng chói.' },
    ...
    '32': { person: 'bà Mưu', action: 'ngoáy tai', object: 'Màng Nhĩ', story: 'Bà Mưu lỡ tay chọc cây bông quá sâu khi ngoáy tai làm thủng cả Màng Nhĩ.' },
    ...
    '34': { person: 'Mẹ Xuân', action: 'Che', object: 'Mưa Rào', story: 'Mẹ Xuân lấy thân mình làm ô Che chắn cho đàn con khỏi cơn Mưa Rào tầm tã.' },
    ...
    '54': { person: 'Bác Sửu thủ thư', action: 'Ngửi', object: 'Sầu Riêng', story: 'Bác Sửu thủ thư nhăn mặt bịt mũi khi cúi xuống Ngửi quả Sầu Riêng nặng mùi.' },
    ...
    '57': { person: 'em Sỏi địa chính', action: 'Sạc điện', object: 'Sạc Pin', story: 'Em Sỏi địa chính tìm ổ cắm để Sạc điện nạp năng lượng cho cục Sạc Pin dự phòng.' },
    ...
    '61': { person: 'chị Biên', action: 'Xỏ lỗ', object: 'Bông Tai', story: 'Chị Biên rùng mình nhắm mắt khi tự tay Xỏ lỗ tai để đeo chiếc Bông Tai mới.' },
    '62': { person: 'Bác Bản ở chùa', action: 'luộc', object: 'Bắp Ngô', story: 'Bác Bản ở chùa đang nhóm lửa đun nước sôi sùng sục để luộc nồi Bắp Ngô nếp.' },
    '63': { person: 'Anh Bảo', action: 'đuổi bắt', object: 'Bóng Ma', story: 'Anh Bảo cầm máy hút bụi Ghostbusters chạy khắp nhà đuổi bắt con Bóng Ma đang bay.' },
    ...
    '68': { person: 'Anh Bách Việt Mỹ', action: 'Chào điều lệnh', object: 'Bác Hồ', story: 'Anh Bách Việt Mỹ mặc quân phục chỉnh tề đứng nghiêm Chào điều lệnh trước tượng Bác Hồ.' },
    ...
    '70': { person: 'bạn Phong', action: 'Nhảy dù cùng', object: 'Phi Công', story: 'Bạn Phong gan dạ ôm chặt eo anh Phi Công rồi cả hai Nhảy dù cùng nhau xuống đất.' },
    ...
    '76': { person: 'Bá Phương', action: 'Đếm', object: 'Phong Bì', story: 'Bá Phương ngồi liếm ngón tay sột soạt Đếm đi đếm lại xấp Phong Bì dày cộp.' },
    '77': { person: 'Phước Thịnh', action: 'Lạy 5 vóc', object: 'Phật Pháp', story: 'Phước Thịnh thành tâm nằm rạp xuống đất Lạy 5 vóc trước biểu tượng Phật Pháp thiêng liêng.' },
    ...
    '81': { person: 'anh Hùng Liên', action: 'Chảy nước mắt', object: 'Hành Tây', story: 'Anh Hùng Liên đang thái rau thì bị cay xè mắt, khóc Chảy nước mắt giàn giụa vì củ Hành Tây.' },
    ...
    '83': { person: 'Hoàng', action: 'Ói', object: 'Hộc Máu', story: 'Hoàng diễn cảnh kiếm hiệp bị nội thương, ôm ngực rên rỉ rồi Ói ra một Hộc Máu giả.' },
    ...
    '89': { person: 'bà Hiệp', action: 'Sàng', object: 'Hạt Gạo', story: 'Bà Hiệp cầm cái mẹt tre khéo léo lắc lắc để Sàng sảy sạch trấu khỏi những Hạt Gạo trắng.' },
    ...
    '92': { person: 'anh Lanh', action: 'Biến dài', object: 'Gậy Như Ý', story: 'Anh Lanh hô to câu thần chú "Biến to" làm cây Gậy Như Ý Biến dài ra chọc thủng trời xanh.' },
    ...
    '96': { person: 'Gì Liên', action: 'quạt ba tiêu', object: 'Gió Bão', story: 'Gì Liên hóa thân thành Thiết Phiến Công Chúa cầm Quạt Ba Tiêu vẫy mạnh tạo ra cơn Gió Bão cuốn bay tất cả.' },
    '97': { person: 'Chú Liệu', action: 'Mở cửa', object: 'Giải Phóng', story: 'Chú Liệu cầm chìa khóa vàng trịnh trọng Mở cửa cổng thành để Giải Phóng đoàn quân chiến thắng đi vào.' },
    ...
    '99': { person: 'Anh Lực', action: 'Trải phẳng', object: 'Ga Giường', story: 'Anh Lực tỉ mỉ vuốt ve từng nếp nhăn và Trải phẳng phiu tấm Ga Giường trắng tinh tươm.' },
    ...
    'JT': { person: 'Jack 5 Củ ca sĩ', action: 'Hét', object: 'Inh Tai', story: 'Jack 5 Củ ca sĩ cầm mic gào Hét lên một nốt cao chót vót làm Inh Tai nhức óc khán giả.' },
    'JB': { person: 'Võ Nguyên Giáp', action: 'Phóng tên lửa', object: 'Người Khổng Lồ', story: 'Võ Nguyên Giáp bình tĩnh ra lệnh ấn nút Phóng tên lửa bay vèo vào gót chân của Người Khổng Lồ.' },
    'QC': { person: 'Chị Quế', action: 'tâng bằng đùi', object: 'Quả Cầu', story: 'Chị Quế mặc váy xòe chơi thể thao, khéo léo co chân tâng bằng đùi trái Quả Cầu lông bay lên xuống.' },
    'QR': { person: 'anh Quý', action: 'khoét', object: 'Quả dứa', story: 'Anh Quý dùng con dao nhọn tỉ mỉ xoay tròn khoét từng cái mắt nâu trên thân Quả dứa (thơm).' },
    ...
    'KR': { person: 'Khoát', action: 'Cài', object: 'Kính Râm', story: 'Khoát điệu đà lấy Kính Râm đen xì ra và Cài lên cổ áo sơ mi cho ngầu.' },
    ...
    'KB': { person: 'thầy Kiên', action: 'Dò bằng máy', object: 'Kho Báu', story: 'Thầy Kiên cầm máy dò kim loại đi rà trên bãi biển để Dò bằng máy tín hiệu phát ra từ rương Kho Báu chôn vùi.' }
};
